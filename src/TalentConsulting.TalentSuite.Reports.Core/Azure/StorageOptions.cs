...
public class StorageOptions
{
    ...
    /// <summary>
    ///     Directly supply EnvironmentName (overrides getting value from environment variable specified by
    ///     EnvironmentNameEnvironmentVariableName).
    /// </summary>
    public string EnvironmentName { get; set; }

    /// <summary>
    ///     Directly supply StorageConnectionString (overrides getting value from environment variable specified by
