...
internal static class ConfigurationBootstrapper
{
    ...
    {
        return GetRequiredEnvironmentVariables(EnvironmentVariableNames.ConfigurationStorageConnectionString,
    ...
    private static EnvironmentVariables GetRequiredEnvironmentVariables(string connectionStringKey,
    ...
    internal static string GetConnectionStringFromEnvironmentVariable(string connectionStringKey,
        string environmentName)
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            ...
            {
                throw new Exception(
                    $"Missing environment variable '{EnvironmentVariableNames.ConfigurationStorageConnectionString}'. It should be present and set to a connection string pointing to the storage account containing a 'Configuration' table.");
            }
        }
